...
pathToCreate = "../userPhotos/" & userID & "/" & planID
...
MyFilecollection(0).SaveAs(Server.MapPath("../userPhotos/" & userID & "/" & planID & "/" & MyFilecollection(0).FileName))

strSQL = "update plan set hasPlanPhoto=1 where uniqueID='" & planID & "'"
