...
<script runat="server"> 
 ...
 Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
      ...
      dim strSQL As String
       ...
       if sortType="0" then 'popular
     
        strSQL  = "Select planID,planText,createDate,latitude,longitude,planDate,planCompleteDate,plan.userID,plan.uniqueID,joins,user.username," & _
                              ...
                              " WHERE active=1 and planDate > now() and plan.userID <>" & userID &"" & _
                              " ORDER BY joins desc,createDate desc limit 75"
                           
        else if sortType="1" then 'soon
        ...
        else if sortType="2" then 'friends
        ...
        strSQL  = "Select planID,planText,createDate,latitude,longitude,planDate,planCompleteDate,plan.userID,uniqueID,joins,user.username," & _
                              ...
                              " inner join user on plan.userID=user.userID" & _
                              " WHERE active=1 and planDate > now() and plan.userID <>" & userID &"" & _
                              " And plan.userID IN (select followingID from friends where followerID=" & userID &")" & _
                              " ORDER BY planDate  limit 75"
